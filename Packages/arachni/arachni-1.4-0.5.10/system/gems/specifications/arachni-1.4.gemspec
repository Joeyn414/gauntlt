...
Gem::Specification.new do |s|
  ...
  s.executables = ["arachni_rpcd".freeze, "arachni_restore".freeze, "arachni_console".freeze, "arachni_rpc".freeze, "arachni_rpcd_monitor".freeze, "arachni_reporter".freeze, "arachni_rest_server".freeze, "arachni_multi".freeze, "arachni_script".freeze, "arachni".freeze]
  s.extra_rdoc_files = ["README.md".freeze, "ACKNOWLEDGMENTS.md".freeze, "LICENSE.md".freeze, "AUTHORS.md".freeze, "CHANGELOG.md".freeze, "CONTRIBUTORS.md".freeze]
  s.files = ["ACKNOWLEDGMENTS.md".freeze, "AUTHORS.md".freeze, "CHANGELOG.md".freeze, "CONTRIBUTORS.md".freeze, "LICENSE.md".freeze, "README.md".freeze, "bin/arachni".freeze, "bin/arachni_console".freeze, "bin/arachni_multi".freeze, "bin/arachni_reporter".freeze, "bin/arachni_rest_server".freeze, "bin/arachni_restore".freeze, "bin/arachni_rpc".freeze, "bin/arachni_rpcd".freeze, "bin/arachni_rpcd_monitor".freeze, "bin/arachni_script".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<concurrent-ruby-ext>.freeze, ["= 1.0.0"])
      ...
      s.add_runtime_dependency(%q<oj>.freeze, ["~> 2.14.3"])
      s.add_runtime_dependency(%q<oj_mimic_json>.freeze, [">= 0"])
      ...
      s.add_runtime_dependency(%q<arachni-rpc>.freeze, ["= 0.2.1.3"])
      s.add_runtime_dependency(%q<typhoeus>.freeze, ["= 1.0.1"])
      s.add_runtime_dependency(%q<addressable>.freeze, ["= 2.3.6"])
      s.add_runtime_dependency(%q<pony>.freeze, ["= 1.8"])
      s.add_runtime_dependency(%q<rb-readline>.freeze, ["= 0.5.1"])
      s.add_runtime_dependency(%q<nokogiri>.freeze, ["= 1.6.8rc2"])
      ...
      s.add_runtime_dependency(%q<loofah>.freeze, ["~> 2.0.0"])
    else
      s.add_dependency(%q<awesome_print>.freeze, [">= 0"])
      s.add_dependency(%q<rack>.freeze, [">= 0"])
      s.add_dependency(%q<bundler>.freeze, [">= 0"])
      s.add_dependency(%q<concurrent-ruby>.freeze, ["= 1.0.0"])
      s.add_dependency(%q<concurrent-ruby-ext>.freeze, ["= 1.0.0"])
      ...
      s.add_dependency(%q<oj>.freeze, ["~> 2.14.3"])
      s.add_dependency(%q<oj_mimic_json>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<arachni-rpc>.freeze, ["= 0.2.1.3"])
      s.add_dependency(%q<typhoeus>.freeze, ["= 1.0.1"])
      s.add_dependency(%q<addressable>.freeze, ["= 2.3.6"])
      s.add_dependency(%q<pony>.freeze, ["= 1.8"])
      s.add_dependency(%q<rb-readline>.freeze, ["= 0.5.1"])
      s.add_dependency(%q<nokogiri>.freeze, ["= 1.6.8rc2"])
      ...
      s.add_dependency(%q<loofah>.freeze, ["~> 2.0.0"])
    end
  else
    s.add_dependency(%q<awesome_print>.freeze, [">= 0"])
    s.add_dependency(%q<rack>.freeze, [">= 0"])
